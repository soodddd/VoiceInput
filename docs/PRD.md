...
> 本文保留为需求基线；当前实现状态、修复内容与尚需真机验证的边界见
> [CODE_REVIEW_FIX_REPORT_2026-09-03.md](CODE_REVIEW_FIX_REPORT_2026-09-03.md)。

> **0.1.4 当前实现说明（2026-09-05）**：实际默认快捷键为 `Alt+V`，点击录音模式也已实现；当前交付方式是完整 PyInstaller onedir ZIP，NSIS/安装器内容仍属于原始需求规划，不能当作已交付能力。最新发布、升级和验证信息见 `RELEASE_NOTES_v0.1.4-preview.*.md`。
...
| 一句话描述 | 按住 `Alt+V` 说话，松开后文字自动出现在光标位置——完全本地运行，不上传任何数据 |
